document.addEventListener("DOMContentLoaded", function () {
    const apiUrl = 'https://api.open-meteo.com/v1/forecast?latitude=47.3769&longitude=8.5417&hourly=temperature_2m,rain,weather_code&forecast_days=1';
...
yesterdayButton.addEventListener("click", async () => {
    ...
    let url = "https://etl.mmp.li/WheelyWeather/etl/unload.php?location=Zurich&date=";
...
threeDaysAgoButton.addEventListener("click", async () => {
    ...
    let url = "https://etl.mmp.li/WheelyWeather/etl/unloadThreeDays.php?location=Zurich";
